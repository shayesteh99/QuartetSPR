...
HDTFactory::HDTFactory(int numD, int total_minus_ones)
{
	this->numD = numD;
    this->total_minus_ones = total_minus_ones;
...
HDT* HDTFactory::getHDT(HDT::NodeType type, RootedTree *link, bool doLink)
{
	...
	returnMe->initialize(type, numD, this->total_minus_ones, link, doLink);
